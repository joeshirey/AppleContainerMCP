...
- **Containers**: `run_container`, `list_containers`, `stop_container`, `remove_container`, `inspect_container`, `get_logs`
- **Images**: `list_images`, `pull_image`, `build_image`, `check_build_status`